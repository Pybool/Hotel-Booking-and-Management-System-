...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'roxandrea.settings')
app = Celery('roxandrea')
...
# celery -A roxandrea worker --loglevel=info -P eventlet
