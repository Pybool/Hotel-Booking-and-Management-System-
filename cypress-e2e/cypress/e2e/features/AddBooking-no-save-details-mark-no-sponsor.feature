Feature: Hotel Admin Add Bookings 
    As a tester i want to validate i can create a new booking with rate selected in dropdown, without saving booking details to contact and without marking a contact as a sponsor

@automated @validatepage
Scenario: On Roxandrea staff module i validate that i can create a new booking with rate selected in dropdown, without saving booking details to contact and without marking a contact as a sponsor
